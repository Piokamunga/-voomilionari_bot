...
from aiogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton, FSInputFile, Update
...
WEBHOOK_URL = f"https://voomilionario.onrender.com{WEBHOOK_PATH}"
...
if __name__ == "__main__":
    if checar_instancia():
        try:
            uvicorn.run("telegrambotpy:app", host="0.0.0.0", port=10000, reload=False)
        finally:
            limpar_instancia()
